...
本仓库作为 [opendcdiag-arm](https://github.com/wangxumarshall/opendcdiag-arm) 的 git submodule,路径 `third-part/rpms-20.03`。目标机离线安装时:

```bash
cd third-part/rpms-20.03/openEuler-20.03LTS_SP4
